package core.gui.component.modern;
...
public abstract class EDMTextfield extends EDText
{
	...
	public EDMTextfield(Color background, Color active, Point location, String title, int maxInput, Color fontColor, int fontSize, int innerThickness, int borderThickness, Color border, boolean visible)
	{
